...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ManualTransfer'
        db.create_table(u'djstripe_manualtransfer', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now)),
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('customer', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'manual_transfers', to=orm['djstripe.Customer'])),
            ('card_num', self.gf('django.db.models.fields.CharField')(max_length=16)),
            ('amount_money', self.gf('django.db.models.fields.DecimalField')(default='0.0', max_digits=16, decimal_places=8)),
            ('money_currency', self.gf('django.db.models.fields.CharField')(max_length=30, null=True)),
            ('amount_btc', self.gf('django.db.models.fields.DecimalField')(default='0.0', max_digits=16, decimal_places=8)),
            ('wallet_transaction_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('status', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0)),
        ))
        db.send_create_signal(u'djstripe', ['ManualTransfer'])


        # Changing field 'Customer.user'
        db.alter_column(u'djstripe_customer', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['core.CoinhandUser'], unique=True, null=True))

    def backwards(self, orm):
        # Deleting model 'ManualTransfer'
        db.delete_table(u'djstripe_manualtransfer')
    ...
    models = {
        ...
        u'djstripe.customer': {
            ...
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'stripe_id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '50'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['core.CoinhandUser']", 'unique': 'True', 'null': 'True'})
        },
        u'djstripe.event': {
        ...
        u'djstripe.manualtransfer': {
            'Meta': {'object_name': 'ManualTransfer'},
            'amount_btc': ('django.db.models.fields.DecimalField', [], {'default': "'0.0'", 'max_digits': '16', 'decimal_places': '8'}),
            'amount_money': ('django.db.models.fields.DecimalField', [], {'default': "'0.0'", 'max_digits': '16', 'decimal_places': '8'}),
            'card_num': ('django.db.models.fields.CharField', [], {'max_length': '16'}),
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'customer': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'manual_transfers'", 'to': u"orm['djstripe.Customer']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'money_currency': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True'}),
            'status': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'}),
            'wallet_transaction_id': ('django.db.models.fields.PositiveIntegerField', [], {})
        },
        u'djstripe.plan': {
